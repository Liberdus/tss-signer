...
pub async fn gg18_keygen_client_new_context(
    ...
    let (party_num_int, uuid) = match signup_keygen(&client, &addr, &operationId).await? {
...
pub async fn signup_keygen(client: &Client, addr: &str, operationId: &str) -> Result<PartySignup> {
